      ...
      <section id="contact" className="contact-section-root">
        ...
        >
          ...
          <header style={{ marginBottom: "80px" }}>
            ...
            >
              Our technical node is open for collaboration, inquiries, and
              glitch reporting. Choose your preferred channel to interface with
              the collective.
            </p>
          </header>
              ...
              >
                ...
                >
                  <span
                    ...
                    style={{ fontSize: "32px", color: "#006565" }}
                  >
                    phone_in_talk
                  </span>
                  <span
            ...
            <div className="contact-bento-right">
              ...
              >
                ...
                >
                  <span
                    className="material-symbols-outlined"
                    style={{ fontSize: "32px", color: "#A33B3C" }}
                  >
                    alternate_email
                  </span>
                  <span
                ...
                <p style={{ fontWeight: "900", color: "#1A1C1A" }}>
                  @cidc_aitpune
                </p>
              </div>
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      border: "2px solid #1A1C1A",
                      padding: "24px",
                      boxShadow: "8px 8px 0px 0px rgba(26, 28, 26, 1)",
                    }}
                  >
                    <h4
                      style={{
                    ...
                    >
                      411015, Alandi Road, Dighi Army Institute of Technology
                    </p>
                    <a
                      href="#"
                      style={{
