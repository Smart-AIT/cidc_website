...
// ==========================================
// 1. FACULTY INCHARGES DATA (Crazy Premium Design)
// ==========================================
const FACULTY_INCHARGES = [
  {
    ref_id: 101,
    name: "Dr. Faculty One", // <-- Yahan real naam daal dena
    role: "Faculty Incharge / Mentor",
    instagram: "#",
    linkedin: "#", // <-- Faculty sir/mam ka LinkedIn profile link
    image: "/image/faculty1.jpg", // <-- public/image me photo daal dena
  },
  {
    ref_id: 102,
    name: "Prof. Faculty Two", // <-- Yahan real naam daal dena
...
// ==========================================
// 4. S.E. SECOND YEAR MEMBERS (Alphabetical Sort + Links Fixed)
// ==========================================
const SE_MEMBERS = [
  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{
        ...
        /* 🛠️ NAVIGATION INTERFACE CONTROLLERS - FIXED TO CENTER BY SIR'S REQUEST */
        .tab-controller-container {
          display: flex;
          justify-content: center; /* Pure Center Align */
          align-items: center;
          gap: 16px;
          margin-bottom: 48px;
          flex-wrap: wrap;
      ...
      <section id="team" className="team-section-root">
        ...
        {/* 🔥 NEW CRAZY FACULTY BLOCK (Fixed at Top) */}
        ...
        {/* Interactive Centered Tab Controller */}
